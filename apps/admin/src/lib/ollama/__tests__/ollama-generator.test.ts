...
Let me know if you need anything else!`;
  ...
  assertEqual(conversion.quiz!.questions.length, 3, 'Quiz has 3 questions');
  assertEqual(conversion.quiz!.questions[0].question_text, 'What is the capital of France?', 'Q1 text matches');
  assertEqual(conversion.quiz!.questions[0].question_type, 'single_choice', 'Q1 is single_choice');
  assertEqual(conversion.quiz!.questions[0].options[0].is_correct, true, 'Q1 option Paris is correct');
  assertEqual(conversion.quiz!.questions[1].question_text, 'Which planet is known as the Red Planet?', 'Q2 text matches');
  assertEqual(conversion.quiz!.questions[2].question_type, 'multiple_choice', 'Q3 is multiple_choice');
