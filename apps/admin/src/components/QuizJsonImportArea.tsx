              ...
              {validationErrors.length > 0 && (
                <div className="p-4 bg-rose-50 border border-rose-200 rounded-xl space-y-2">
                  <div className="flex items-center gap-2 text-rose-800 font-semibold text-xs">
                    ...
                    <span>JSON Validation Failed ({validationErrors.length} {validationErrors.length === 1 ? 'error' : 'errors'} found):</span>
                  </div>
                  ...
                  <div className="flex items-start gap-2.5">
                    ...
                    <div className="space-y-0.5">
                      <p className="font-semibold text-emerald-900">
                        Imported successfully: {importSummary.questionsCount} questions, {importSummary.optionsCount} options
                        {importSummary.sectionsCount > 0 ? `, ${importSummary.sectionsCount} sections` : ''}!
                      </p>
